...
const FORM_SLUG = "quito-alcaldia-2026";
...
export default function EncuestaQuito() {
  ...
  async function submit() {
    ...
    if (normalized !== "quito") {
  return setErrorMsg("Captcha incorrecto. Escribe la palabra Quito para enviar.");
}
  ...
  <span className="text-xs font-semibold px-3 py-1 rounded-full border border-yellow-400 text-yellow-300 bg-yellow-500/10">
    2027
        ...
        <section className="bg-gray-900 border border-gray-800 rounded-xl p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ej: Quito (cabecera), etc."
            />
          </div>
      ...
      {step === 3 && (
        <section className="bg-gray-900 border border-gray-800 rounded-xl p-5 space-y-4">
          <h3 className="text-lg font-semibold">Prioridades para Quito</h3>
      ...
      {step === 4 && (
        <section className="bg-gray-900 border border-gray-800 rounded-xl p-5 space-y-4">
          ...
          <div className="bg-gray-950 border border-gray-800 rounded-lg p-3">
            ...
            <p className="text-sm text-yellow-300 font-semibold mt-1">Quito</p>
          </div>
